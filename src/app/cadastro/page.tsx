...
export default function Cadastro() {
    ...
    async function insertProd(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
        console.log('Dados do formulário:', formData); // Adicionando um console.log para verificar os dados do formulário antes de enviar
        const response = await fetch('http://localhost:3000/api/cadastro', { // Atualizando a URL da rota de cadastro
            method: 'POST',
            headers: {
                                ...
                                <Sheet>
                                    ...
                                    <SheetContent>
                                        <SheetHeader>
                                            ...
                                            <SheetDescription>
                                                Faço o cadastro de produtos, depois salve para a lista se atualizar.
                                            </SheetDescription>
                                        </SheetHeader>
                                        ...
                                        <div className="grid gap-4 py-4">
                                            <div className="grid grid-cols-4 items-center gap-4">
                                                ...
                                                <Input name="categoria" type="text" placeholder="" required className="col-span-3" onChange={handleChange} value={formData.categoria}/>
                                            </div>
                                            <div className="grid grid-cols-4 items-center gap-4">
                                                <Label htmlFor="nome" className="text-right">
                                                    Nome
                                                </Label>
                                                <Input name="nome" type="text" placeholder="" required className="col-span-3" onChange={handleChange} value={formData.nome}/>
                                            </div>
                                            <div className="grid grid-cols-4 items-center gap-4">
                                                <Label htmlFor="marca" className="text-right">
                                                    Marca
                                                </Label>
                                                <Input name="marca" type="text" placeholder="" required className="col-span-3" onChange={handleChange} value={formData.marca}/>
                                            </div>
                                            <div className="grid grid-cols-4 items-center gap-4">
                                            ...
                                            <div className="grid grid-cols-4 items-center gap-4">
                                                ...
                                                <Input name="valor_total" type="text" placeholder="" required className="col-span-3" onChange={handleChange} value={formData.valor_total}/>
                                            </div>
                                            <div className="grid grid-cols-4 items-center gap-4">
                                            ...
                                            <div className="grid grid-cols-4 items-center gap-4">
                                                ...
                                                <Input name="validade" type="text" placeholder="" required className="col-span-3" onChange={handleChange} value={formData.validade}/>
                                            </div>
                                        </div>
                                        <SheetFooter>
                                            <SheetClose asChild>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell>Sabão</TableCell>
                                    <TableCell>Ypê</TableCell>
                                    <TableCell>5</TableCell>
                                    <TableCell>23,99</TableCell>
                                    <TableCell>01/01/01</TableCell>
                                    <TableCell className="text-right">02/02/02</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
